...
public class CalcPeopleRank {
    ...
    public static void run() throws InterruptedException, IOException, ClassNotFoundException {
        ...
        String inPath1 = HadoopUtil.HDFS + "/people_output/probility-matrix";
        String inPath2 = HadoopUtil.HDFS + "/people_input/peoplerank.csv";
        //String inPath_2 = HadoopUtil.HDFS_pr+"/people_input/peoplerank.csv";
        String outPath = HadoopUtil.HDFS + "/people_output/pr";
        //String outPath_2 = HadoopUtil.HDFS_pr + "/people_output/pr";
